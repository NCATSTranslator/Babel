...
rule drugchemical_conflation:
    ...
    resources:
        # Peaked at ~57 GB on both babel-1.17 and 2026jul22 (see docs/tools/Resources.md), i.e. 89%
        # of 64 GB -- raised a bucket rather than run the next release that close to an OOM.
        mem="96G",
    run:
