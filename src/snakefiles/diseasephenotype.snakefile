...
rule get_hp_mp_concord:
    output:
        ...
        metadata_yaml=config["intermediate_directory"] + "/disease/concords/metadata-HP_MP.yaml",
    run:
        # SSSOM mapping files curated by the Mouse-Human Ontology Mapping Initiative
        # (https://github.com/mapping-commons/mh_mapping_initiative). Keep this list in
        # sync with docs/sources/MP/README.md.
        hp_mp_sssom_inputs = [
            {
                "name": "mp_hp_eye_impc",
                "url": "https://raw.githubusercontent.com/mapping-commons/mh_mapping_initiative/master/mappings/mp_hp_eye_impc.sssom.tsv",
                "description": "IMPC Mouse Morphology Mappings: Eye Morphology Test.",
            },
            {
                "name": "mp_hp_hwt_impc",
                "url": "https://raw.githubusercontent.com/mapping-commons/mh_mapping_initiative/master/mappings/mp_hp_hwt_impc.sssom.tsv",
                "description": "IMPC Mouse Morphology Mappings: Heart Weight Test.",
            },
            {
                "name": "mp_hp_mgi_all",
                "url": "https://raw.githubusercontent.com/mapping-commons/mh_mapping_initiative/master/mappings/mp_hp_mgi_all.sssom.tsv",
                "description": "All mappings of MP terms to HPO terms generated by MGI (Mouse Genome Informatics) consolidated from KidsFirst, scoliosis, Alzheimer, cleft palate, Down Syndrome, CHARGE Syndrome, Cornelia De Lange Syndrome, and COVID term sets.",
            },
            {
                "name": "mp_hp_owt_impc",
                "url": "https://raw.githubusercontent.com/mapping-commons/mh_mapping_initiative/master/mappings/mp_hp_owt_impc.sssom.tsv",
                "description": "IMPC Mouse Morphology Mappings: Organ Weight Test.",
            },
            {
                "name": "mp_hp_pat_impc",
                "url": "https://raw.githubusercontent.com/mapping-commons/mh_mapping_initiative/master/mappings/mp_hp_pat_impc.sssom.tsv",
                "description": "IMPC Mouse Morphology Mappings: Gross Pathology & Tissue Collection Test (Phenotype).",
            },
            {
                "name": "mp_hp_pistoia",
                "url": "https://raw.githubusercontent.com/mapping-commons/mh_mapping_initiative/master/mappings/mp_hp_pistoia.sssom.tsv",
                "description": "Pistoia Alliance Ontology Mappings: mp_hp (expert curation).",
            },
            {
                "name": "mp_hp_xry_impc",
                "url": "https://raw.githubusercontent.com/mapping-commons/mh_mapping_initiative/master/mappings/mp_hp_xry_impc.sssom.tsv",
                "description": "IMPC Mouse Morphology Mappings: X-ray Test.",
            },
        ]
