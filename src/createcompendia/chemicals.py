...
def make_chebi_relations(sdf, dbx, outfile, propfile_gz, metadata_yaml):
    ...
    # READ SDF
    ikeys = {x: x for x in CHEBI_SDF_KEYS}
    ...
    # Backstop to check_chebi_sdf_keys(): that catches a renamed tag, this catches any other way
