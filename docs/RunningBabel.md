...
these ids are placed into `/babel_downloads/chemical/ids`. Each file is a two-column file containing
...
`babel_downloads/chemical/concords`. Each concord is a three-column file of the format:
