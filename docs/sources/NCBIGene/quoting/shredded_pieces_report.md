...
Source: `babel_downloads/NCBIGene/gene_info.gz`. Generated by `shredded_pieces_report.py`; the full
per-gene record is [`shredded_pieces.csv`](./shredded_pieces.csv).
