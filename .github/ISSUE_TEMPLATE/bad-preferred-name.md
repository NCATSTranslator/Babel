---
name: Bad, incorrect or unclear preferred name
...
https://nodenormalization-sri.renci.org/1.5/get_normalized_nodes?curie=curie&conflate=true&drug_chemical_conflate=true&description=true&individual_types=true&include_taxa=true

And copy the resulting JSON into the following JSON code block:
...
{{BabelTest|HasPreferredName|curie|correct}}
-->
